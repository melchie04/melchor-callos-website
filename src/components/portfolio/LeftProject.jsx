...
const LeftProject = ({ project }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row lg:mx-44 sm:mx-20 xs:mx-10 mx-5 md:my-20 my-10"
    >
      <div className="flex-1 flex md:justify-end justify-center items-center md:pr-10 md:mb-0 mb-5">
        <div
      ...
      <div className="flex-1 flex md:justify-start justify-center items-center md:pl-10 md:mt-0 mt-5">
